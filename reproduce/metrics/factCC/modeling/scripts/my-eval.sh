...
export DATA_PATH=/home/gaomq/factCC/samsum/data4test_model # absolute path to data directory
...
export RESULT_PATH=/home/gaomq/factCC/samsum_model/GOLD
<< EOF
